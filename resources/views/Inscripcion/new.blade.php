        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" required class="form-control" id="curso_id" name="curso_id" placeholder="Id Curso"> 
                </div>
                
                <div class="mb-3">
                    <label for="nombre" class="form-label">Id Instructor</label>
                    <input type="text" required class="form-control" id="instructor_id" name="instructor_id" placeholder="Id Instructor"> 
                </div>

                <div class="mb-3">
                    <label for="nombre" class="form-label">Id estudiante</label>
                    <input type="text" required class="form-control" id="estudiante_id" name="estudiante_id" placeholder="Id Estudiante"> 
                </div>

                <div class="mb-3">
                    <label for="nombre" class="form-label">Fecha de inscripcion</label>
                    <input type="text" required class="form-control" id="fecha_inscripción" name="fecha_inscripción" placeholder="Fecha de inscripcion"> 
                </div>
